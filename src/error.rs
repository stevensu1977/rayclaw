...
mod tests {
    ...
    fn test_error_from_io() {
        ...
        let e: RayClawError = io_err.into();
    ...
    fn test_error_from_json() {
        ...
        let e: RayClawError = json_err.into();
